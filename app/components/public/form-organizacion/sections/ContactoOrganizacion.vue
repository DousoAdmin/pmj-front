...
<template>
  <form @submit.prevent="nextStep">
    ...
    <div class="mb-4">
      ...
      <input v-model="localValue.web" type="text" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-600 font-normal focus:text-gray-800 focus:border-gray-400" />
    </div>
    <div class="mb-4">
      <label class="block font-normal text-gray-600 mb-1">Facebook</label>
      <input v-model="localValue.facebook" type="text" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-600 font-normal focus:text-gray-800 focus:border-gray-400" />
    </div>
    <div class="mb-4">
      <label class="block font-normal text-gray-600 mb-1">Instagram</label>
      <input v-model="localValue.instagram" type="text" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-600 font-normal focus:text-gray-800 focus:border-gray-400" />
    </div>
    <div class="mb-4">
      <label class="block font-normal text-gray-600 mb-1">Otros enlaces de redes sociales</label>
      <input v-model="localValue.otrosEnlaces" type="text" class="w-full border border-gray-300 rounded px-3 py-2 text-gray-600 font-normal focus:text-gray-800 focus:border-gray-400" />
    </div>
